...
namespace Domain.Profiles
{
    public class UserProfile : Profile
    {
        public UserProfile()
        {
            ...
            //    .ForMember(destino => destino.Id, opt => opt.MapFrom(src => src.Id))
            //    .ForMember(destino => destino.Role, opt => opt.MapFrom(src => src.Role))
            //    .ForMember(destino => destino.Addresses, opt => opt.MapFrom(src => src.Addresses))
            //    .ForMember(destino => destino.CreatedAt, opt => opt.MapFrom(src => src.CreatedAt))
            //    .ForMember(destino => destino.UpdatedAt, opt => opt.MapFrom(src => src.UpdatedAt)); 
